...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <html class="rss-document" lang="zh-CN">
      <head>
        <meta charset="utf-8"/>
      ...
      <body class="rss-page">
        <main class="rss-container">
              ...
              <div class="podcast-header-image-title">
                ...
                <div>
                  ...
                  <xsl:if test="rss/channel/itunes:author">
                    <p>作者：<span class="podcast-author"><xsl:value-of select="rss/channel/itunes:author"/></span></p>
                  </xsl:if>
                  ...
                  <xsl:if test="rss/channel/link[1]">
                    <p>
                      <a target="_blank" rel="noopener">
                        ...
                        访问网站 <span class="icon-arrow-right"></span>
                      </a>
                    </p>
                  </xsl:if>
                </div>
                  ...
                  <xsl:if test="enclosure/@url">
                    <xsl:choose>
                      ...
                      <xsl:when test="starts-with(enclosure/@type, 'text')">
                        <a class="enclosure-link" target="_blank" rel="noopener">
                          <xsl:attribute name="href"><xsl:value-of select="enclosure/@url"/></xsl:attribute>
                          查看 <span class="icon-arrow-right"></span>
                        </a>
                      </xsl:when>
                      <xsl:otherwise>
                        <a class="enclosure-link" target="_blank" rel="noopener">
                          <xsl:attribute name="href"><xsl:value-of select="enclosure/@url"/></xsl:attribute>
                          下载 <span class="icon-arrow-right"></span>
                        </a>
                      </xsl:otherwise>
                    </xsl:choose>
                  </xsl:if>
              ...
              <nav class="pagination" aria-label="分页">
                <xsl:if test="rss/channel/atom:link[@rel='prev']">
                  <a>
                    ...
                    <span class="icon-arrow-left"></span> 上一页
                  </a>
                </xsl:if>
                <xsl:if test="rss/channel/atom:link[@rel='next']">
                  <a>
                    ...
                    下一页 <span class="icon-arrow-right"></span>
                  </a>
                </xsl:if>
              </nav>
            </xsl:if>
          ...
          <footer class="text-sm text-center">
            ...
            <div>
              由 <a class="mf-footer-link" href="https://www.microfeed.org/">microfeed</a> 提供支持
