...
const ZH_CN: Record<string, string> = {
  ...
  "The credential's account lacks the content:chapter:create permission.":
    "该凭据所属账号缺少 content:chapter:create 权限。",
  "The credential's account lacks the content:chapter:delete permission.":
    "该凭据所属账号缺少 content:chapter:delete 权限。",
  "The credential's account lacks the content:chapter:update permission.":
    "该凭据所属账号缺少 content:chapter:update 权限。",
  "The credential's account lacks the content:channel:manage permission.":
    "该凭据所属账号缺少 content:channel:manage 权限。",
  "The credential's account lacks the content:page:manage permission.":
    "该凭据所属账号缺少 content:page:manage 权限。",
  "The credential's account lacks the content:site_file:manage permission.":
    "该凭据所属账号缺少 content:site_file:manage 权限。",
  "The credential's account is rate limited.":
    "该凭据所属账号请求过于频繁，请稍后重试。",
  "The credential's account lacks the media:file:manage permission.":
    "该凭据所属账号缺少 media:file:manage 权限。",
  "The file exceeds the 100 MiB per-object upload limit.":
    "文件超过单对象 100 MiB 的上传上限。",
  "The file type is not on the upload allowlist.":
    "该文件类型不在上传白名单内。",
