...
export const PERMISSION_CODES = {
  ...
  CONTENT_ARTICLE_CREATE: 'content:chapter:create',
  CONTENT_ARTICLE_READ: 'content:chapter:read',
  CONTENT_ARTICLE_UPDATE: 'content:chapter:update',
  CONTENT_ARTICLE_DELETE: 'content:chapter:delete',
