import {adminUrl, browserAdminPath} from "./AdminPath";
...
export const PERMISSION_CODES = {
  ...
  CONTENT_CHAPTER_CREATE: 'content:chapter:create',
  CONTENT_CHAPTER_READ: 'content:chapter:read',
  CONTENT_CHAPTER_UPDATE: 'content:chapter:update',
  CONTENT_CHAPTER_DELETE: 'content:chapter:delete',
...
export const ITEM_STATUSES_DICT = {
  ...
  [STATUSES.UNPUBLISHED]: {
    name: 'unpublished',
    get description() {
      return '<b>not listed</b> on the web/rss/json feed, and <b>not visible</b> via the direct web link. ' +
        `An admin can still find it and edit on the <a href="${adminUrl("items/list", browserAdminPath())}">See all items</a> page.</li>`;
    },
  },
  [STATUSES.UNLISTED]: {
    name: 'unlisted',
