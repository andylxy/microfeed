...
INSERT OR IGNORE INTO ext_permissions (id, code, name) VALUES
  ...
  ('p_content_article_create', 'content:article:create', '新建章节'),
  ('p_content_article_read', 'content:article:read', '查看章节'),
  ('p_content_article_update', 'content:article:update', '编辑章节'),
  ('p_content_article_delete', 'content:article:delete', '删除章节'),
